...
function CreateNewFunfic() {
  ...
  return (
    <Container>
      {message && message.type === SUCCESS_MESSAGE_TYPE && (
        <SuccessAlert successMessage={message.content} />
      )}
      {message && message.type === ERROR_MESSAGE_TYPE && (
        <ErrorAlert errorMessage={message.content} />
      )}
      {unauthenticatedMessage && (
        <ErrorAlert errorMessage={unauthenticatedMessage} />
      )}
