...
import {blockUser, deleteUserById, fetchUser, updateUserRoles} from "../../api/adminApi";
...
function UserSettings() {
  ...
  return (
    <Container>
      ...
      <Row>
        <Form inline>
          <Col><Button variant="danger" onClick={onDelete}>
            Delete
          </Button></Col>
          <Col>
      ...
      <Row>
        <Col><UserRolesForm onRolesChosen={updateRoles}/></Col>
      </Row>
    </Container>
  );
}
